...
def oracle_actions():
    ...
    actions = (
        actions + [1] * 7
    )  # angle 270, current-pos: (2.16, 0.00, 7.49) - turn right
    actions = (
        actions + [2] * 70
    )  # angle 270, current-pos: (2.01, 0.00, 16.48) - walk forwards
    actions = (
        actions + [0] * 6
    )  # angle 83, current-pos: (1.98, 0.00, 17.98) - turn left
    actions = (
        actions + [2] * 20
    )  # angle 0,  current-pos: (4.98, 0.00, 18.04) - walk forwards
    actions = (
        actions + [1] * 6
    )  # angle 270, current-pos: (4.98, 0.00, 18.04) - turn right
    actions = (
        actions + [2] * 40
    )  # angle 270, current-pos: (4.88, 0.00, 24.03) - walk forwards
    actions = actions + [0] * 6  # angle 0, current-pos: (4.88, 0.00, 24.03) - turn left
    actions = (
        actions + [2] * 20
    )  # angle 0, current-pos: (7.88, 0.00, 24.09) - walk forwards
    actions = (
        actions + [0] * 6
    )  # angle 89, current-pos: (7.88, 0.00, 24.09) - turn left
    actions = (
        actions + [2] * 20
    )  # angle 89, current-pos: (7.93, 0.00, 21.09) - walk forwards
